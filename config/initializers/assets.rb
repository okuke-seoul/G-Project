...
Rails.application.config.assets.precompile += %w( jquery.vegas.min.css )
...
Rails.application.config.assets.precompile += %w( jquery.vegas.min.js )
Rails.application.config.assets.precompile += %w( detectmobilebrowser.js )
Rails.application.config.assets.precompile += %w( jquery.scrollstop.min.js )
...
Rails.application.config.assets.precompile += %w( functions.min.js )
Rails.application.config.assets.precompile += %w( initialise-functions.js )
